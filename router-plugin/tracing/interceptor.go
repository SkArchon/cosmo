...
func CreateTracingInterceptor(tracingOpts TracingOptions, tracingConfig *config.Tracing) (func(ctx context.Context, req interface{}, info *grpc.UnaryServerInfo, handler grpc.UnaryHandler) (interface{}, error), error) {
	if tracingConfig == nil {
		return nil, errors.New("nil tracing config not supported")
	}

	// TODO: We currently don't have shutdown logic
