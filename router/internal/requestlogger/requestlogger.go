...
type ContextFunc func(fields []config.CustomAttribute, exprFields []ExpressionAttribute, panic any, r *http.Request, rh *http.Header) []zapcore.Field
...
func (h *handler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	defer func() {
		...
		if err := recover(); err != nil {
			...
			if h.accessLogger.fieldsHandler != nil {
				fields = append(fields, h.accessLogger.fieldsHandler(h.accessLogger.attributes, h.accessLogger.exprAttributes, err, r, nil)...)
			}
	...
	if h.accessLogger.fieldsHandler != nil {
		resFields = append(resFields, h.accessLogger.fieldsHandler(h.accessLogger.attributes, h.accessLogger.exprAttributes, nil, r, nil)...)
	}
